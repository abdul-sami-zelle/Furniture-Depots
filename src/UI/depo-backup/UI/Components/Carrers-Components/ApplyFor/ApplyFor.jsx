        ...
        <form className='apply-for-main' onSubmit={handleSubmitCareerForm}>
            ...
            <div className='career-form-first-and-last-name-container'>
                <label className='apply-for-input-labels'>
                    ...
                    <input
                        ...
                        style={{ borderColor: error.firstName ? 'red' : '#d7d7d7', color: error.lastName ? 'red' : 'var(--text-gray)' }}
                    />
                </label>
                ...
                <label className='apply-for-input-labels'>
                    ...
                    <input
                        ...
                        onChange={handleInputChange}
                        style={{ borderColor: error.lastName ? 'red' : '#d7d7d7', color: error.lastName ? 'red' : 'var(--text-gray)' }}
                    />
                </label>
            </div>
            ...
            <label className='apply-for-input-labels'>
                ...
                <input
                    ...
                    onChange={handleInputChange}
                    style={{ borderColor: error.contact ? 'red' : '#d7d7d7', color: error.contact ? 'red' : 'var(--text-gray)' }}
                />
            </label>
            ...
            <label className='apply-for-input-labels'>
                ...
                <input
                    ...
                    onChange={handleInputChange}
                    style={{ borderColor: error.email ? 'red' : '#d7d7d7', color: error.email ? 'red' : 'var(--text-gray)' }}
                />
            </label>
            ...
            <div className='career-form-zip-and-city'>
                <div className='career-form-zip-container'>
                    ...
                    <label className='apply-for-input-labels'>
                        ...
                        <input
                            ...
                            style={{ borderColor: error.zipCode ? 'red' : '#d7d7d7', color: error.zipCode ? 'red' : 'var(--text-gray)' }}
                        />
                    </label>
                </div>
                ...
                <label className='apply-for-input-labels'>
                    ...
                    <input
                        ...
                        onChange={handleInputChange}
                        style={{ borderColor: error.city ? 'red' : '#d7d7d7', color: error.city ? 'red' : 'var(--text-gray)' }}
                    />
                </label>
            </div>
            ...
            <label className='apply-for-input-labels'>
                ...
                <input
                    ...
                    onChange={handleInputChange}
                    style={{ borderColor: error.state ? 'red' : '#d7d7d7', color: error.state ? 'red' : 'var(--text-gray)' }}
                />
            </label>
